    <?php
        ...
        function sportNewsJson(){
            $jsondata = file_get_contents("task8.2.json");
...
<a href="task8.2.php?category=sport">Sport news</a> | <a href="task8.2.php?category=politics">Politic news</a><br/><br/>
<a href="task8.2.php?category=sport&format=json">Sport news (JSON)</a> | <a href="task8.2.php?category=politics&format=json">Politic news (JSON)</a><br/><br/>